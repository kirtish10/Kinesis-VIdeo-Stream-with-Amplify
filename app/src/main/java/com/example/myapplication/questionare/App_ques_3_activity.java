...
public class App_ques_3_activity extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_ques_3_activity);
        ...
        rb1 = findViewById(R.id.ques3_rb1);
        rb2 = findViewById(R.id.ques3_rb2);
        rb3 = findViewById(R.id.ques3_rb3);
        rb4 = findViewById(R.id.ques3_rb4);
        button = findViewById(R.id.ques3_button);
...
//                RequestQueue requestQueue = Volley.newRequestQueue(App_ques_3_activity.this);
//
//                JSONObject jsonBody = new JSONObject();
//                try {
//                    jsonBody.put("questionNo", 3);
...
//                            Intent i = new Intent(App_ques_3_activity.this, App_ques_4_activity.class);
//                            startActivity(i);
